...
void CSampleMenuView::OnContextMenu(CWnd* /* pWnd */, CPoint point)
{
	...
	menu.AppendMenu(MF_ENABLED, ID_MYMENU_MORNING, _T("Morning"));
	menu.AppendMenu(MF_ENABLED, ID_MYMENU_EVENING, _T("Evening"));
	menu.AppendMenu(MF_ENABLED, ID_MYMENU_DRAWING, _T("Drawing"));
	GetCursorPos(&point);
