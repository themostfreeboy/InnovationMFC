...
int main(int argc, char *argv[])
{
	...
	c->addTitle("拳击力的折线统计图", "timesbi.ttf", 15)->setBackground(
		0xccccff, 0x000000, Chart::glassEffect());

	// Add a title to the y axis
	c->yAxis()->setTitle("打击的拳击力的大小");
	...
	layer->addDataSet(DoubleArray(data2, (int)(sizeof(data2) / sizeof(data2[0]))),
		c->dashLineColor(0x3333ff, Chart::DashLine), "第三次打击");

	// Output the chart
	c->makeChart("Boxing.png");
